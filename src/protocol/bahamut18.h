...
MODULEVAR const char MSG_USERIP[] = "USERIP";		/* USER -> USRH */
...
MODULEVAR const char MSG_SVSHOLD[] = "SVSHOLD";		/* SVSHOLD */
...
MODULEVAR const char MSG_LUSERSLOCK[] = "LUSERSLOCK";     /* Lusers LOCK */
MODULEVAR const char MSG_LINKSCONTROL[] = "LINKSCONTROL"; /* LINKSCONTROL */
MODULEVAR const char MSG_MODULE[] = "MODULE";		/* MODULE */
MODULEVAR const char MSG_RWHO[] = "RWHO";         /* RWHO */
MODULEVAR const char MSG_SVSCLONE[] = "SVSCLONE";     /* SVSCLONE */
