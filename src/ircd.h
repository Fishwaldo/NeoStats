 ...
 */
extern const int ircd_minprotocol;
/* The optional protocols that are negotiated during connection that the
 * protocol module supports but will work when not available e.g. SJOIN
 */
extern const int ircd_optprotocol;
/* The features provided by this protocol module e.g. SVSNICK support.
 */
extern const int ircd_features;
